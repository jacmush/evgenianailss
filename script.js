...
var showNumberButton = document.getElementById("showNumberButton");
var phoneNumber = document.getElementById("phoneNumber");

// Добавляем обработчик события на клик по кнопке
showNumberButton.addEventListener("click", function(event) {
    event.preventDefault(); // Отменяем переход по ссылке
    phoneNumber.style.display = "block"; // Показываем номер телефона
    showNumberButton.style.display = "none"; // Скрываем кнопку
});
